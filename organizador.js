...
(function () {
  ...
  var FOTOS = [
    ...
    ['img/og-packs.webp?v=1',
     ...
     'Cómo se maneja', 'Asas reforzadas y plegable',
     'Las asas aguantan para llevarla cargada de un lugar a otro sin esfuerzo. Y cuando no la usas, se pliega y la guardas sin que ocupe espacio.'],

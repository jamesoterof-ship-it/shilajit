...
(function () {
  ...
  var TEXTOS = {
    ...
    'Guirnalda Solar Decorativa': [
      'La terraza quedo otra cosa, ahora comemos afuera',
      'Diez metros alcanzaron justo para cruzar el patio',
      'La luz es calida, no esa blanca fea de hospital',
      'La colgue en la pergola en menos de diez minutos',
      'No hay que enchufarla a nada, eso fue lo mejor',
      'Le puse el panel en el pasto donde pega el sol toda la tarde',
      'Se ve mucho mas cara de lo que costo',
      'Aguanto la lluvia de la semana pasada sin problema',
      'Las ampolletas son grandes, se ven bonitas apagadas tambien',
      'El cable es grueso y firme, no se ve barato',
      'La puse en el balcon del departamento y quedo preciosa',
      'Compre dos para rodear todo el quincho',
      'Mi senora queria luces para el cumpleanos y quedo perfecto',
      'No sube nada la cuenta de la luz, cero consumo',
      'El panel es chico y no estorba donde lo puse',
      'Llego bien embalada, ninguna ampolleta rota',
      'La luz llega hasta la mesa, se puede conversar tranquilo',
      'Se la regale a mi mama y quedo feliz con su patio',
      'Lleva un mes afuera y sigue igual de bien',
      'Las ampolletas no calientan, se pueden tocar',
      'La colgue del arbol hasta la reja y alcanzo de sobra',
      ...
      'Ordene el cable con unas amarras y quedo perfecta',
      'La use para el matrimonio de mi hermana en el jardin',
      'Resistio el viento del sur sin soltarse',
      'Pague al recibir, eso me dio confianza',
      'El vidrio de las ampolletas se ve de buena calidad',
      'La terraza pasa de oscura a acogedora, asi de simple',
      'Compre la de tres y cubri el patio, el quincho y la entrada',
      'Se guarda facil si uno la quiere descolgar',
